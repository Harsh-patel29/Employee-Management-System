...
export const createTaskTimer = createAsyncThunk("tasktimer/createTaskTimer",async(data,{rejectWithValue})=>{
    try {
        const res = await axios.post("http://localhost:8000/api/v6/tasktimer/create",data,{withCredentials:true})
        return res.data
    } catch (error) {
        return rejectWithValue(error.response?.data?.message || error.message)
    }
})  
export const updateTaskTimer = createAsyncThunk("tasktimer/updateTaskTimer",async(data,{rejectWithValue})=>{
    try {
        const res = await axios.post("http://localhost:8000/api/v6/tasktimer/update",data,{withCredentials:true})
        return res.data
    } catch (error) {
        return rejectWithValue(error.response?.data?.message || error.message)
    }
...
export const getTaskTimer = createAsyncThunk("tasktimer/getTaskTimer",async(id,{rejectWithValue})=>{
    try {
        const res = await axios.post("http://localhost:8000/api/v6/tasktimer/get",id,{withCredentials:true})
        return res.data
    } catch (error) {
        return rejectWithValue(error.response?.data?.message || error.message)
    }
...
export const getTaskByUser = createAsyncThunk("tasktimer/getTaskByUser",async(data,{rejectWithValue})=>{
    try {
        const res = await axios.post("http://localhost:8000/api/v6/tasktimer/gettaskbyuser",data,{withCredentials:true})
        return res.data
    } catch (error) {
        return rejectWithValue(error.response?.data?.message || error.message)
    }
...
export const getAllTaskTimer = createAsyncThunk("tasktimer/getAllTaskTimer",async(_,{rejectWithValue})=>{
    try {
        const res = await axios.get("http://localhost:8000/api/v6/tasktimer/getalltasktimer",{withCredentials:true})
        return res.data
    } catch (error) {
        return rejectWithValue(error.response?.data?.message || error.message)
    }
...
export const deleteTaskTimer = createAsyncThunk("tasktimer/deleteTaskTimer",async(id,{rejectWithValue})=>{
    try {
        const res = await axios.delete("http://localhost:8000/api/v6/tasktimer/delete",{data:id,withCredentials:true})
        return res.data
    } catch (error) {
        return rejectWithValue(error.response?.data?.message || error.message)
    }
...
export const {resetTaskTimer,resetTaskByUser,resetAllTaskTimer} = taskTimerSlice.actions

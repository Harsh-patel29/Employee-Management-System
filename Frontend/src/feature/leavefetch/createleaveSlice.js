...
export const deleteLeave = createAsyncThunk("leave/delete",async(id,{rejectWithValue})=>{
    ...
    export const getCreatedLeave = createAsyncThunk("leave/getCreatedLeave",async(_,{rejectWithValue})=>{
        try {
            const res = await axios.get("http://localhost:8000/api/v5/leave/get-created-leave",{withCredentials:true})  
            return res.data
        } catch (error) {
            return rejectWithValue(error)
        }
    ...
    export const updateCreatedLeave = createAsyncThunk("leave/updateCreatedLeave",async({data,id},{rejectWithValue})=>{
        try {
            const res = await axios.put("http://localhost:8000/api/v5/leave/update-created-leave",{data,id},{withCredentials:true})
            return res.data
        }catch(error){
            return rejectWithValue(error)
        }
    ...
    export const getCreatedLeaveById = createAsyncThunk("leave/getCreatedLeaveById",async(id,{rejectWithValue})=>{
        try {
            const res = await axios.post("http://localhost:8000/api/v5/leave/get-created-leave-by-id",{id},{withCredentials:true})
            return res.data
        }catch(error){
            return rejectWithValue(error)
        }
    ...
    export const deleteCreatedLeave = createAsyncThunk("leave/deleteCreatedLeave",async(id,{rejectWithValue})=>{
        try {
            const res = await axios.delete("http://localhost:8000/api/v5/leave/delete-created-leave",{data:id,withCredentials:true})
            return res.data
        }catch(error){
            return rejectWithValue(error)
        }
    ...
    export const approveLeave = createAsyncThunk("leave/approve",async(id,{rejectWithValue})=>{
        try {
            const res = await axios.post("http://localhost:8000/api/v5/leave/approve-leave",{id},{withCredentials:true})
            return res.data
        }catch(error){
            return rejectWithValue(error)
        }
    ...
    export const rejectLeave = createAsyncThunk("leave/reject",async(id,{rejectWithValue})=>{
        try {
            const res = await axios.post("http://localhost:8000/api/v5/leave/reject-leave",{id},{withCredentials:true})
            return res.data
        }catch(error){
            return rejectWithValue(error)
        }
...
export const {resetLeave,resetError,resetNewLeave,resetCreatedLeave,resetUpdatedNewLeave,resetDeletedCreatedLeave,resetApprovedLeave,resetRejectedLeave} = createleaveSlice.actions

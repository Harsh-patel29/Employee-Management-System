...
import {getAllTaskTimer,deleteTaskTimer} from "../feature/tasktimerfetch/tasktimerslice.js"
function Row({row,openDialog}){
    ...
    return(
        <React.Fragment>
            ...
            >
              <MdDelete
                className="font-semibold text-lg text-[#ff3b30]" 
              />
            </DialogTrigger>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  This action cannot be undone. This will permanently delete the task timer.
                  <Button
...
export default function TaskTimerTable(){
    const dispatch = useDispatch()
    const{allTaskTimer,createdTaskTimer,updatedTaskTimer,deletedTaskTimer}= useSelector((state)=>state.tasktimer)

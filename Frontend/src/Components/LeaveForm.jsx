...
Cancel
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem >
                <FormLabel className={errors?.LEAVE_TYPE ? "text-[#737373]":"text-[16px] font-[500]"}>Leave Type</FormLabel>
                <FormControl>
                    <Select 
                    {...field}
                styles={{
  ...
  '&:hover': {
    borderColor: state.isFocused ? 'rgb(101,101,101)' : 'rgb(120, 122, 126)',
                  ...
                  value={typeof field.value === 'string' ? LeaveTypeOptions.find(option => option.value === field.value) : field.value}
            ...
            <div>
              {errors?.LEAVE_TYPE && <span className="text-red-500 font-semibold">{errors.LEAVE_TYPE.message}</span>}
            </div>
              </FormItem>
            )}
            />
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col">
                <FormLabel className={errors?.Start_Date ? "text-[#737373]":"text-sm font-medium text-gray-700"}>Start Date</FormLabel>
                <FormControl>
                 <DatePicker 
                 {...field}
              ...
              onChange={(date)=>{
                ...
                field.onChange(localDate)
                    ...
                    <div>
                      {errors?.Start_Date && <span className="text-red-500 font-semibold">{errors.Start_Date.message}</span>}
                    </div>
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col ">
                <FormLabel {...field} className={`${errors?.StartDateType ? "text-[#737373] h-2" : "text-[16px] font-[500]"}`}>Start Date</FormLabel>
                <FormControl>
                             <Select 
                styles={{
                      control: (baseStyles, state) => ({
    ...
    boxShadow: 'none',
            ...
            <div>
              {errors?.StartDateType && (
                <span className="text-red-500 font-semibold">{errors.StartDateType.message}</span>
              )}
            </div>
              </FormItem>
            )}
            ...
            render={({ field }) => (
              ...
              onChange={(date)=>{
                ...
                field.onChange(localDate)
                    ...
                    <div>
                      {errors?.End_Date && (
                        <span className="text-red-500 font-semibold">{errors.End_Date.message}</span>
                      )}
                    </div>
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel htmlFor="End_Date_Type" className={errors?.EndDateType ? "text-[#737373]":""}>End Date</FormLabel>
                <FormControl>
                  <Select {...field}
                styles={{
                         control: (baseStyles, state) => ({
  ...
  '&:hover': {
    borderColor: state.isFocused ? 'rgb(101,101,101)' : 'rgb(120, 122, 126)',
                       ...
                       value={typeof field.value === 'string' ? EndDateTypeOptions.find(option => option.value === field.value) : field.value}
              ...
              />
                      ...
                      <div>
                        {errors?.EndDateType && <span className="text-red-500 font-semibold">{errors.EndDateType.message}</span>}
                      </div>
              </FormItem>
            )}
          />

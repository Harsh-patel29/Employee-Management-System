...
const TaskTimer = () => {
    ...
    return (
        <div className='fixed bottom-2 right-2 m-4'>
            <button onClick={()=>setOpenTimer(true)} className='bg-transparent border-[rgb(120,173,196)] border-2 text-white p-2 rounded-full flex items-center justify-center cursor-pointer'>
<svg stroke="currentColor"  fill="rgb(120,173,196)" stroke-width="0" viewBox="0 0 24 24" class="timer" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg">

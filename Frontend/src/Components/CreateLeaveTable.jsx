...
import { createNewLeave,getCreatedLeave,updateCreatedLeave,getCreatedLeaveById,resetNewLeave,resetUpdatedNewLeave ,deleteCreatedLeave,resetDeletedCreatedLeave,resetError} from "../feature/leavefetch/createleaveSlice";
...
Row.propTypes = {
 ...
 export default function CreateLeaveTable() {
  const dispatch = useDispatch();
  const {createdLeaves,newLeave,updatedNewLeave,deletedCreatedLeave,error} = useSelector((state)=>state.leave)
...
<line x1="8" y1="12" x2="16" y2="12"></line>
            ...
            <SheetContent showCloseButton={false}
              ...
              <SheetHeader>
                <SheetDescription>
                <CreateLeaveForm onSubmit={(data)=>{dispatch(createNewLeave(data))}}/>
                </SheetDescription>
              </SheetHeader>
            </SheetContent>
          </Sheet>
